...
<div class="sidebar">
	...
	<button id="sidebar_button" type="button" data-toggle="popover" title="Customer Management" data-content="Here you can create, update, delete and view customer profiles.
	You can also to view a details about sale per costumer by klik his costumer id" data-placement="bottom"><i class="fas fa-question"></i> Help</button>
