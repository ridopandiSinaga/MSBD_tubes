					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" name="number" pattern='\d{12}' title='Phone Number (Format: 081234567890)' value="<?php echo $row['contact_number'];?>" class="form-control form-control-sm" required></div></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Change Photo:</td>
								<td><input class="form-control-sm pl-5 w-100" type="file" name="image" style="padding-left:80px;"></td>
							</tr>
						</tbody>
					</table>
